...
public interface SysCategoryMapper {
     ...
     * @return 结果
     */
    public int selectDeptCount(SysCategory dept);
     ...
     * @return 结果
     */
    public int updateDeptChildren(@Param("depts") List<SysCategory> depts);
     ...
     * @param dept 部门
     */
    public void updateDeptStatus(SysCategory dept);
     ...
     * @return 部门列表
     */
    public List<SysCategory> selectChildrenDeptById(Long deptId);
}
