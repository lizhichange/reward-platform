...
public class ObjectUtil {
     ...
     * ObjectUtil.identityToString("")            = "java.toolkit.String@1e23"
     * ObjectUtil.identityToString(Boolean.TRUE)  = "java.toolkit.Boolean@7fa"
     * ObjectUtil.identityToString(new int[0])    = "int[]@7fa"
     * ObjectUtil.identityToString(new Object[0]) = "java.toolkit.Object[]@7fa"
     * </pre>
     *
     * @param object 对象
     *
     ...
     * ObjectUtil.identityToString("", "NULL")              = "java.toolkit.String@1e23"
     * ObjectUtil.identityToString(Boolean.TRUE, "NULL")    = "java.toolkit.Boolean@7fa"
     ...
     * ObjectUtil.appendIdentityToString(null, "")           = "java.toolkit.String@1e23"
     * ObjectUtil.appendIdentityToString(null, Boolean.TRUE) = "java.toolkit.Boolean@7fa"
     * ObjectUtil.appendIdentityToString(buf, Boolean.TRUE)  = buf.append("java.toolkit.Boolean@7fa")
     * ObjectUtil.appendIdentityToString(buf, new int[0])    = buf.append("int[]@7fa")
     * ObjectUtil.appendIdentityToString(buf, new Object[0]) = buf.append("java.toolkit.Object[]@7fa")
     * </pre>
     *
