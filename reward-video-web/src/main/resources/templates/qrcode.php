...
<div class="body" id="body">
    ...
    <div class="mod-ct">
        ...
        <div id="orderbody">
            ...
            <div class="time-item">
                <div class="time-item" id="msg" style="margin-bottom:15px; margin-top: 15px;">
                    <h1><span style="border-style:solid;border-radius:10px;border-color:#3ec742; border-width:1px; padding:6px; color:#1eb6e4; font-size:1.7rem;" onclick="jumpAction();">支付成功点击跳转</span><br></h1>
                </div>
            </div>
    ...
    function check(){
		$.ajax({
			...
			success: function(obj){
				if(obj.code==0){ 
					jumpUrl = '<?php echo $_REQUEST["returnUrl"]?>';
