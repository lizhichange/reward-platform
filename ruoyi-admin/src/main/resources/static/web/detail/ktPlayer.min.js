...
!function (a, b) {
    ...
    c.prototype = {
        init: function () {
            ...
            var a = parseFloat(e.currentTime), b = a / e.duration * 100;
            ...
            var c, f = b || a.event, g = d.target.querySelector(".ktPlayer-bar");
            ...
            var a = d.target.querySelector(".ktPlayer-icon-fullscreen"), b = a.getAttribute("data-on");
