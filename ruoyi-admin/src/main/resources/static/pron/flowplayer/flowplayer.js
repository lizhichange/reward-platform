...
(function (e) {
    ...
    b(e.HTMLCommentElement.prototype, c, "nodeValue"), b(e.HTMLScriptElement.prototype, null, "text"), b(h, null, "nodeValue"), b(e.HTMLTitleElement.prototype, null, "text"), u(e.HTMLStyleElement.prototype, "textContent", function (e) {
        ...
        textContent: {get: S, set: N}, firstElementChild: {
            get: function () {
                ...
                function hlsjsExt(video, api, engineApi) {
                    ...
                    hls.on(Hls.Events.MANIFEST_PARSED, function (_, data) {
                        ...
                        if (Array.isArray(hlsQualities)) {
                            var confAutoQuality = hlsQualities.find(function (q) {
                                return q === -1 || q.level && q.level === -1;
                            });
            ...
            flowplayer(function (e, o) {
                ...
                if ("file:" == location.protocol && (f = "localhost"), e.load.ed = 1, n.hostname = f, n.origin = i || location.href, i && l(o, "is-embedded"), "string" == typeof s && (s = s.split(/,\s*/)), s && "function" == typeof key_check && key_check(s, f)) {
                    ...
                    7 !== g && (d || o).appendChild(u), e.on("pause resume finish unload ready", function (e, a) {
                        var l = -1;
                        if (a.video.src) for (var n = [["org", "flowplayer", "drive"], ["org", "flowplayer", "my"], ["org", "flowplayer", "cdn"], ["com", "flowplayer", "cdn"]], t = 0; t < n.length && (l = a.video.src.indexOf("://" + n[t].reverse().join(".")), -1 === l); t++) ;
