...
!function (a) {
    ...
    a(document).mousemove(function (c) {
        if (b) {
            var e = a(b).offset(), f = c.pageX, g = c.pageY;
        ...
        return this.each(function () {
            var e = this, f = a(this).attr("data-preview");
            f && a(this).mouseover(function () {
                d(), c = setTimeout(function () {
                    ...
                    c && clearTimeout(c), a(b.parentNode).removeClass("preview-loading"), a(b).css({visibility: "visible"})
...
$(document).ready(function () {
    String.prototype.trim = function () {
        ...
        for (var a = {}, b = window.pageContext, c = {
            effect: "fadeIn",
        ...
        }, e = /iphone|ipad|Android|webOS|iPod|BlackBerry|Windows Phone/gi.test(navigator.appVersion), f = function (a, c) {
            ...
            if (a) for (var c = a.split(";"), d = 0; d < c.length; d++) {
                var e = c[d].split(":");
                if (2 == e.length) for (var f = e[0].split("+"), g = 0; g < f.length; g++) b[f[g]] = decodeURIComponent(e[1]).replace(/[+]/g, " ")
            }
            return b
        }, j = function (b, c, d, e) {
            var f = d.url ? d.url : window.location.href;
            f.indexOf("#") > 0 && (f = f.substring(0, f.indexOf("#"))), $.ajax({
            ...
            d.indexOf("#") > 0 && (d = d.substring(0, d.indexOf("#"))), $.ajax({
                ...
                success: function (a) {
                    "object" != typeof a && (a = JSON.parse(a)), a && c && c(a)
                }
            })
        }, l = function (c, d) {
            var e = function (a, b) {
            ...
            b && b.server_error && (f = b.server_error), c.ajaxForm({
                data: {format: "json", mode: "async"}, beforeSerialize: function () {
                    c.find("[data-form-populate-from]").each(function () {
                    ...
                    var f = !0;
                    return d && d.beforeSubmit && (f = d.beforeSubmit(c, a)), e(c, f), f
                }, uploadProgress: function (a, b, e, f) {
                    d && d.uploadProgress && d.uploadProgress(c, f)
                }, success: function (a, b, g) {
                    if (c.find(".generic-error").empty().hide(), e(c, !1), g.getResponseHeader("Content-Type").indexOf("application/json") >= 0) if ("object" != typeof a && (a = JSON.parse(a)), "failure" == a.status) {
                        for (var i = 0; i < a.errors.length; i++) {
                            var j = a.errors[i], k = j.field, l = j.code, m = j.message, n = null;
                            if (k) {
                                var o = c.find('[name="' + k + '"]');
                                if (o.exists() || (o = c.find('[data-name="' + k + '"] [type="text"]')), o.exists() || (o = c.find('[data-name="' + k + '"] select')), o.exists()) {
                                    if (o.addClass("error"), o.parents(".file-control").find('[type="text"]').addClass("error"), n = o.parent().find(".field-error"), !n.exists()) {
                            ...
                            if (n && n.exists() || (n = c.find(".generic-error")), n.empty().text(m).fadeIn(), "code" == k && "required" != l) {
                        ...
                        d && d.error && d.error(c), h(c, 0)
                    } else if ("success" == a.status) if (d && d.success) d.success(c, a.data); else if (a.redirect) window.location = a.redirect; else {
                        var r = $("[data-reload-to]");
                        r.exists() ? window.location = r.attr("data-reload-to") : window.location.reload()
                    } else c.find(".generic-error").text(f).show(), h(c, 0), d && d.error && d.error(c); else g.getResponseHeader("Content-Type").indexOf("text/html") >= 0 ? d && d.success ? d.success(c, a) : "message" == $(a).attr("data-fancybox") || $(a).find('[data-fancybox="message"]').exists() ? $.fancybox($(a), {
                        topRatio: .3,
                        beforeClose: function () {
                            var a = this.inner.find("[data-fancybox-redirect-to]");
                            return a.exists() ? window.location = a.attr("data-fancybox-redirect-to") : window.location.reload(), !0
                        }
                    }) : c.empty().append(a) : (c.find(".generic-error").text(f).show(), h(c, 0), d && d.error && d.error(c))
                }, error: function () {
                    e(c, !1), c.find(".generic-error").text(f).show(), h(c, 0), d && d.error && d.error(c)
                }, complete: function () {
                    d && d.complete && d.complete(c)
                }
            }), c.find("input, select, textarea").each(function () {
                var a = $(this), b = function () {
                    a.parent().find(".field-error").fadeOut(), a.removeClass("error"), a.parents("fieldset").removeClass("error"), a.parents(".file-control").find('[type="text"]').removeClass("error")
                };
                a.change(b), "textarea" != a.get(0).tagName.toLowerCase() && "text" != a.get(0).type && "password" != a.get(0).type || a.keypress(b)
                ...
                if (a.attr("multiple") && (!c || 1 == c.length)) {
                    var f = e.clone(!0, !0);
                ...
                a.find('[type="text"]').focus(function () {
                    ...
                    a.find(".list-selector-popup").exists() ? (a.find(".list-selector-popup").show(), a.find('[name="filter"]').focus()) : c && d && $.ajax({
                        url: c, type: "GET", beforeSend: function () {
                            ...
                            for (var f = [], g = [], h = "", i = $('<div class="list-selector-popup">' + c + "</div>"), j = i.find('[name="filter"]'), k = 0; k < e.length; k++) {
                                var l = e[k].trim();
                                if (l) {
                            ...
                            a.append(i), i.find('input[type="checkbox"]').click(function () {
                                ...
                                var c = $(this), h = i.find('label[for="' + c.attr("id") + '"]');
                                if (h.html()) {
                                    var j = c.prop("value");
                                ...
                                a.is(b.target) || 0 !== a.has(b.target).length || i.hide()
                            })
                        }
                    })
                })
                ...
                $(this).click(function () {
                    if (!$(this).hasClass("disabled")) {
                        ...
                        if (a.find('[data-action="choose"] [type="radio"]').prop("checked", !1), b.prop("checked", !0), b.prop("checked")) {
                            a.find('[data-action="choose"]').removeClass("active"), $(this).addClass("active");
                            var c = a.find(".captcha-control");
                            c.exists() && ("payment_option" == b.attr("name") ? (c.append(c.parent().find('[type="submit"]')), c.parent().find("label").removeClass("hidden"), c.removeClass("hidden")) : "card_package_id" == b.attr("name") && (c.parent().append(c.find('[type="submit"]')), c.parent().find("label").addClass("hidden"), c.addClass("hidden")))
                        }
                    }
                })
            })
                ...
                afterShow: function () {
                    c || (this.inner.find('[data-form="ajax"]').each(function () {
                        ...
                        $(this).click(function (a) {
                            a.preventDefault(), m($(this), this.href || $(this).attr("data-href"))
                        })
                    })), g(this.inner), c && c.call(this)
                }, beforeClose: function () {
                    return this.inner.find('[data-fancybox="refresh"]').exists() ? a && a.attr("data-fancybox-refresh-id") ? n(a.attr("data-fancybox-refresh-id"), a, !1, !0) : window.location.reload() : a && a.attr("data-fancybox-refresh-id") && n(a.attr("data-fancybox-refresh-id"), a, !1, !0), !0
            ...
            i.success = function (d, i) {
                ...
                f || (j = 1), e && h($("#" + c)), $("#" + c).animate({opacity: j}, 400, function () {
                    ...
                    if ($(d).css("opacity", j), $(this).replaceWith(d), $("#" + c).animate({opacity: 1}, 400), z($("#" + c)), "undefined" != typeof Storage) {
                        var e = "";
            ...
            i.error = function () {
                k++;
                var a = !1;
                for (var b in g) g.hasOwnProperty(b) && 0 == b.indexOf("from") && parseInt(g[b]) > 1 && (g[b] = parseInt(g[b]) - 1, k > 1 && (g[b] = 1), a = !0);
                a || (g = null), k > 1 && delete i.error, j(c, d, i, g)
            }, j(c, d, i, g)
        }, o = function () {
            ...
            if (a.exists()) {
                ...
                a.each(function () {
                    if (0 == $(this).attr("href").indexOf("#")) {
                        ...
                        d && a != window.location.hash || (d = a), b[a] = $(this), c += "," + a
                    }
                });
                var e = $(c ? c.substr(1) : "");
            ...
            var b = $(".movable-top, .movable-bottom"), c = function () {
                b.each(function () {
                    var a;
                    if ($(this).hasClass("movable-top")) if ((a = $(this).parent().height() - $(this).height()) > 0) {
                    ...
                    } else $(this).offset().top > 0 && $(this).css({top: "0px"}); else if ((a = $(this).parent().height() - $(this).height()) > 0) {
            ...
            b.click(function (c) {
                ...
                if (!d.hasClass("disabled") && !d.hasClass("voted")) {
                    var e = parseInt(d.attr("data-vote")) || 0, f = d.attr("data-video-id"),
                        g = d.attr("data-album-id"), h = d.attr("data-playlist-id"), i = d.attr("data-post-id"),
                        j = d.attr("data-model-id"), l = d.attr("data-cs-id"), m = d.attr("data-dvd-id"),
            ...
            $(".btn-favourites li a").click(function (a) {
                ...
                (c || d) && (a.preventDefault(), b.hasClass("delete") ? k(b.parents("li"), {
                    ...
                    "success" == a.status && (g > 0 ? (b.parents("li").addClass("hidden"), b.parents("ul").find("#add_playlist_" + g).removeClass("hidden")) : (b.parents("li").addClass("hidden"), b.parents("ul").find("#add_fav_" + e).removeClass("hidden")))
                }) : 10 != e || g ? k(b.parents("li"), {
                    ...
                    "success" == a.status && (g > 0 ? (b.parents("li").addClass("hidden"), b.parents("ul").find("#delete_playlist_" + g).removeClass("hidden")) : (b.parents("li").addClass("hidden"), b.parents("ul").find("#delete_fav_" + e).removeClass("hidden")))
                }) : f && m(b, f, function () {
            ...
            var a = $(".block-share");
            a.exists() && ("function" == typeof window.getEmbed && a.find(".embed-code").val(window.getEmbed()), a.find(".embed-button").click(function (b) {
                if (b.preventDefault(), "function" == typeof window.getEmbed) {
            ...
            var c = $(".block-comments"), d = c.find(".block-new-comment");
            if (c.exists() && d.exists()) {
                c.find(".toggle-button").click(function (b) {
                    if (b.preventDefault(), $(this).toggleClass("active"), d.toggle(), c.find(".success").hide(), d.is(":visible")) {
                        var e = d.find(".captcha-control img");
                        e.exists() && (e.attr("data-src") ? e.attr("src", e.attr("data-src").replace(new RegExp("rand=\\d+"), "rand=" + (new Date).getTime())) : e.attr("src", e.attr("src").replace(new RegExp("rand=\\d+"), "rand=" + (new Date).getTime())))
                    }
                    g(d), a.movable && a.movable()
                });
                var e = c.find("form");
                e.exists() && l(e, {
                    success: function (f, g) {
                        var h = f.find('[name="anonymous_username"]'), i = h.val();
                        i && $.cookie("kt_anonymous_username", i, {path: "/"}), f.get(0).reset(), h.val(i || "");
                        var k = f.find(".captcha-control img");
                        k.exists() && k.attr("src", k.attr("src").replace(new RegExp("rand=\\d+"), "rand=" + (new Date).getTime())), c.find(".toggle-button").exists() && (d.hide(), c.find(".toggle-button").removeClass("active"));
                        var l = c.attr("data-block-id"), m = $(".list-comments");
                        if (g && g.approved && l && m.exists()) {
                            j(l, null, {
                                success: function (c, d) {
                                    if ("undefined" != typeof Storage) {
                                        var e = "";
                                        b && b.userId && (e = b.userId + ":"), sessionStorage.removeItem(e + location.href + "#" + l), sessionStorage.removeItem(e + location.href + "#" + l + ":params")
                                    }
                                    var f = document.createElement("DIV");
                                    f.innerHTML = d;
                                    var h = $(f).find('.item[data-comment-id="' + (g.comment_id || g.entry_id) + '"]').addClass("hidden");
                                    m.find("#" + l + "_items").prepend(h), setTimeout(function () {
                                        m.show(), h.fadeIn(), a.movable && a.movable()
                                    }, 200)
                                }
                            })
            ...
            $(".list-comments").on("click", ".comment-options a", function (a) {
                var c = $(this), d = $(this).parents(".item"), e = $(this).parents(".comment-options"),
                    f = e.find(".comment-rating"), h = e.find(".comment-like, .comment-dislike"),
                    i = d.attr("data-comment-id");
                if (c.hasClass("comment-like") || c.hasClass("comment-dislike")) {
                    if (a.preventDefault(), c.hasClass("disabled")) return;
                    var m = c.hasClass("comment-dislike") ? -1 : 1;
                    k(c, {action: "vote_comment", vote: m, comment_id: i}, function (a) {
                        if ("success" == a.status) {
                            if (h.fadeOut(), f.exists()) {
                                var b = parseInt(f.html());
                                isNaN(b) || (b += m, f.html(b), b > 0 ? f.addClass("positive") : b < 0 ? (f.addClass("negative"), d.addClass("dim-comment")) : 0 == b && (f.removeClass("positive").removeClass("negative"), d.removeClass("dim-comment")))
                            }
                    ...
                    afterShow: function () {
                        ...
                        c = c.replace(/<br>/gi, "\n").replace(/&gt;/gi, ">").replace(/&lt;/gi, "<").replace(/&#34;/gi, '"'), c = c.replace(/<img.*?alt=['"](.*?)['"].*?>/gi, "$1"), a.find('[name="comment"], [name="entry"]').val(c), l(a, {
                            success: function () {
                                $.fancybox.close();
                                var a = $(".block-comments"), c = a.attr("data-block-id");
                                if (c) {
                                    j(c, null, {
                                        success: function (a, e) {
                                            if ("undefined" != typeof Storage) {
                                                var f = "";
                                                b && b.userId && (f = b.userId + ":"), sessionStorage.removeItem(f + location.href + "#" + c), sessionStorage.removeItem(f + location.href + "#" + c + ":params")
                                            }
            ...
            function u(a, b, c) {
                return function (d) {
                    if ("success" == d.status) if (n(c, b, !0, !0), a.attr("data-refresh-block-ids")) for (var e = a.attr("data-refresh-block-ids").split(","), f = 0; f < e.length; f++) n(e[f], b, !1, !0); else b.attr("data-redirect-url") && (window.location = b.attr("data-redirect-url")); else {
                        for (var g = 0; g < d.errors.length; g++) {
                            var i = d.errors[g], j = i.message;
            ...
            if (g) g.find('[data-fancybox="ajax"]').each(function () {
                $(this).click(function (a) {
                    a.preventDefault(), m($(this), this.href || $(this).attr("data-href"))
                })
            }); else if (g = $(document), "undefined" != typeof Storage) {
                var o = {};
                ...
                for (var q in o) if (o.hasOwnProperty(q)) {
                    ...
                    r || (r = sessionStorage.getItem(location.href + "#" + q)), r && $("#" + q).html(r).find('[data-fancybox="ajax"]').each(function () {
                        $(this).click(function (a) {
                            a.preventDefault(), m($(this), this.href || $(this).attr("data-href"))
                        })
                    });
                    var s = sessionStorage.getItem(p + location.href + "#" + q + ":params");
                    if (s || (s = sessionStorage.getItem(location.href + "#" + q + ":params")), s) {
                        try {
                            a[q] = JSON.parse(s)
                        } catch (a) {
                        }
            ...
            if ($.fn.lazyload && (e ? g.find("img.lazy-load").each(function () {
                var a = $(this).attr("data-original");
                a && (this.src = a)
            }) : g.find("img.lazy-load").lazyload(f(c, "lazyload"))), $.fn.thumbs && (e || g.find("img[data-cnt]").thumbs()), $.fn.videopreview && (e || g.find("img[data-preview]").videopreview()), g.find('[data-action="ajax"]').click(function (a) {
                a.preventDefault();
                var c = {}, e = $(this), f = e.attr("data-append-items-to"),
                    g = parseInt(e.attr("data-max-queries")) || 0, k = e.attr("data-block-id");
                if (k) {
                    var l = e.attr("data-container-id");
                    if (g && f) {
                        var m = parseInt($("#" + f).attr("data-current-queries")) || 0;
                        if (!(m < g)) return;
                        m++, m == g ? $("#" + l).remove() : $("#" + f).attr("data-current-queries", m)
                    }
                    var n = i(e.attr("data-parameters")), o = "";
                    b && b.userId && (o = b.userId + ":"), c.success = function (a, b) {
                        if (f) {
                            ...
                            var g = $(c).find("#" + f + " .item");
                            g.css({display: "none"}), "true" == $("#" + f).attr("data-append-to-beginning") ? g.insertBefore($("#" + f).find(".item").first()) : g.insertAfter($("#" + f).find(".item").last()), g.fadeIn().promise().done(function () {
                                for (var a in n) if (n.hasOwnProperty(a) && 0 == a.indexOf("from") && parseInt(n[a]) > 1) {
                                    delete n[a];
                                    break
                                }
                                d[k] || "undefined" != typeof Storage && (sessionStorage.setItem(o + location.href + "#" + k, $("#" + k).html()), sessionStorage.setItem(o + location.href + "#" + k + ":params", JSON.stringify(n)))
                            }), z(g)
                        } else h($("#" + k)), $("#" + k).animate({opacity: .1}, 400, function () {
                            var a = document.createElement("div");
                            a.innerHTML = b;
                            var c = $(a).find("#" + k);
                            $(c).css("opacity", "0.1"), $(this).replaceWith(c), $("#" + k).animate({opacity: 1}, 400), z($("#" + k)), "undefined" != typeof Storage && (sessionStorage.setItem(o + location.href + "#" + k, $("#" + k).html()), sessionStorage.setItem(o + location.href + "#" + k + ":params", JSON.stringify(n)))
                        })
                    }, j(k, l ? $("#" + l) : e, c, n)
                }
                ...
                if (a) {
                    ...
                    (new Image).src = b + (b.indexOf("?") >= 0 ? "&" : "?") + "mode=async&action=rotator_videos&pqr=" + a, $(this).attr("data-rt", "")
                }
            }), g.find("[data-playlist-item]").click(function (b) {
                b.preventDefault(), g.find("[data-playlist-item]").removeClass("selected");
                var c = $(this);
                c.addClass("selected");
                ...
                if (d) {
                    ...
                    e.url = d, e.success = function (a, b) {
                        $(".player").html("").append($(b.trim()).find(".player-holder")), $(".player-holder").find('[data-fancybox="ajax"]').each(function () {
                            $(this).click(function (a) {
                                a.preventDefault(), m($(this), this.href || $(this).attr("data-href"))
                            })
            ...
            }), a.playlist_state) g.find("[data-playlist-item]").each(function () {
                $(this).attr("data-playlist-item") == a.playlist_state && $(this).addClass("selected")
            }); else {
                var t = g.find("[data-playlist-item]").first();
                t.exists() && t.addClass("selected").click()
            }
            g.find("[data-fav-video-id]").click(function (a) {
                ...
                k(c, {
                    ...
                    "failure" == a.status && a.errors && a.errors[0] && "not_logged_in" == a.errors[0].code ? b && b.loginUrl && m(c, b.loginUrl) : c.addClass("fixed")
                })
            }), g.find("[data-fav-album-id]").click(function (a) {
                a.preventDefault(), a.stopPropagation();
                var c = $(this), d = c.attr("data-fav-album-id"), e = c.attr("data-fav-type") || 0;
                k(c, {action: "add_to_favourites", album_id: d, album_ids: [d], fav_type: e}, function (a) {
                    "failure" == a.status && a.errors && a.errors[0] && "not_logged_in" == a.errors[0].code ? b && b.loginUrl && m(c, b.loginUrl) : c.addClass("fixed")
                })
                ...
                $(this).click(function (a) {
                    if (!$(this).hasClass("disabled")) {
                        ...
                        c.prop("checked") ? ($(this).addClass("active"), d++) : ($(this).removeClass("active"), d = Math.max(d - 1, 0)), b.find('input[data-mode="selection"]').prop("disabled", 0 == d), b.find('input[data-action="select_all"]').toggleClass("active", d == b.find("input[type=checkbox]").length - b.find("input[type=checkbox][disabled]").length), b.attr("data-selected-cnt", d)
                    }
                })
                ...
                $(this).click(function (a) {
                    if (a.preventDefault(), !$(this).hasClass("disabled")) {
                        ...
                        if (!d || confirm(d)) {
                            ...
                            if (!e) return;
                            var f = b.attr("data-block-id"), g = i(b.attr("data-parameters"));
                            g.function = "get_block", g.block_id = f, g.delete = [e], k(c, g, u(b, c, f))
                        }
                    }
                })
                ...
                a.find('input[type="button"]').each(function () {
                    $(this).click(function (c) {
                        ...
                        if (e) {
                            ...
                            e = e.replace(/\[count\](.*)\[\/count\]/gi, function (a, b) {
                                for (var c = "", d = b.split("||"), e = 0; e < d.length; e++) {
                                    var g = d[e].split(":", 2);
                                    if (1 == g.length) c = g[0].trim(); else for (var h = g[0].split(","), i = 0; i < h.length; i++) {
                                        var j = h[i].trim();
                                        if (0 == j.indexOf("//")) {
                        ...
                        var g = {};
                        if (!e || confirm(e)) if ("select_all" == d.attr("data-action")) d.hasClass("active") ? a.find("input[type=checkbox]").each(function () {
                            this.checked && $(this).click()
                        }) : a.find("input[type=checkbox]").each(function () {
                            this.checked || $(this).click()
                        }); else if ("delete_multi" == d.attr("data-action")) g = i(a.attr("data-parameters")), g.function = "get_block", g.block_id = b, g.delete = [], a.find("input[type=checkbox]").each(function () {
                            this.checked && g.delete.push(this.value)
                        }), k(d, g, u(a, d, b)); else if ("move_multi" == d.attr("data-action")) {
                            ...
                            h && m(d, h, function () {
                                ...
                                l(c, {
                                    beforeSubmit: function (c) {
                                        ...
                                        if (e) g = i(a.attr("data-parameters")), g.function = "get_block", g.block_id = b, g.move_to_playlist_id = e, g.delete = [], a.find("input[type=checkbox]").each(function () {
                                            this.checked && g.delete.push(this.value)
                                        }), k(d, g, u(a, d, b)); else {
                                            ...
                                            f && m(d, f, function () {
                                                ...
                                                l(c, {
                                                    success: function (c, f) {
                                                        $.fancybox.close(), f = $(f), (e = f.attr("data-playlist-id")) && (g = i(a.attr("data-parameters")), g.function = "get_block", g.block_id = b, g.move_to_playlist_id = e, g.delete = [], a.find("input[type=checkbox]").each(function () {
                                                            this.checked && g.delete.push(this.value)
                                                        }), k(d, g, u(a, d, b)))
                                                    }
                                                })
                        ...
                        } else if ("redirect" == d.attr("data-action")) {
                            var j = d.attr("data-redirect-url");
                            if (!j) return;
                            window.location = j
                        } else if ("delete_playlist" == d.attr("data-action")) {
                            var n = d.attr("data-id");
                            if (!n) return;
                            g.action = "delete_playlists", g.delete = [n], k(d, g, u(a, d, b))
                        } else if ("delete_dvd" == d.attr("data-action")) {
                            var o = d.attr("data-id");
                            if (!o) return;
                            g.action = "delete_dvds", g.delete = [o], k(d, g, u(a, d, b))
                        }
                    })
                })
            }), a.movable && a.movable()
            ...
            $("[data-subscribe-to], [data-unsubscribe-to]").click(function (a) {
                a.preventDefault();
                var b = $(this);
                if (!b.hasClass("done")) {
                    ...
                    if (c && d) {
                        ...
                        b.attr("data-subscribe-to") || (e.action = "unsubscribe"), "category" == c ? e[e.action + "_category_id"] = d : "model" == c ? e[e.action + "_model_id"] = d : "content_source" == c ? e[e.action + "_cs_id"] = d : "user" == c ? e[e.action + "_user_id"] = d : "playlist" == c ? e[e.action + "_playlist_id"] = d : "dvd" == c && (e[e.action + "_dvd_id"] = d), k(b, e, function (a) {
                            if ("success" == a.status) {
                                b.addClass("done");
                                var c = b.parents().first().find(".button-info");
                                c.exists() && ("subscribe" == e.action ? c.html(parseInt(c.html()) + 1) : c.html(parseInt(c.html()) - 1))
                            }
                        })
                    }
                }
            ...
            if ("undefined" != typeof Storage) {
                ...
                if (d || (d = sessionStorage.getItem(location.href + "#search_filter")), d) {
                    d = JSON.parse(d);
            ...
            $("#search_form").submit(function (a) {
                try {
                    if ("" == this.q.value) return this.q.focus(), void a.preventDefault();
                    if ($(this).attr("data-url")) {
                        var b = this.q.value.replace(/[ ]+/g, "-").replace(/[?]/g, "").replace(/[&]/g, "%26").replace(/[?]/g, "%3F").replace(/[/]/g, "%2F");
                ...
                if ("undefined" != typeof Storage) {
                    ...
                    e || (e = sessionStorage.getItem(location.href + "#search_filter")), e = e ? JSON.parse(e) : {search_string_filter: !0}, $(this).attr("id") && ($(this).prop("checked") ? e[$(this).attr("id")] = !0 : delete e[$(this).attr("id")]), sessionStorage.setItem(d + location.href + "#search_filter", JSON.stringify(e))
                }
                var f = c.attr("data-search-filter-ids").split(","), g = {}, h = {};
                c.find("input").each(function () {
                    var a = $(this);
                    if ("hidden" == a.prop("type") || "checkbox" == a.prop("type") && a.prop("checked")) if (a.prop("name").indexOf("[]") > 0) {
                        var b = a.prop("name").replace("[]", "");
                        if (a.attr("data-group-id")) {
                            var c = h[b] || {}, d = c[a.attr("data-group-id")] || [];
                            d.push(a.prop("value")), c[a.attr("data-group-id")] = d, h[b] = c
                        } else g[b] = a.prop("value") + (g[b] ? "," + g[b] : "")
                    } else g[a.prop("name")] = a.prop("value")
                });
                for (var i in h) if (h.hasOwnProperty(i)) {
                    var j = [];
                    for (var k in h[i]) h[i].hasOwnProperty(k) && j.push("(" + h[i][k].join(",") + ")");
                    g[i] = j.join("|")
                }
                for (var l in g) g.hasOwnProperty(l) && "all" == g[l] && delete g[l];
                for (var m = 0; m < f.length; m++) a[f[m]] = g, n(f[m], c, !1, !0)
            })
        }, D = function () {
            $('[data-form="ajax-upload"]').each(function () {
                var a = $(this), b = a.attr("data-redirect-url"), c = a.attr("data-progress-url"),
                    d = a.attr("data-continue-form"), e = 0, f = null, g = function (b) {
                        (b = Math.min(b || 0, 100)) > e && (a.find(".progressbar .progress").stop(!0, !0).animate({width: b + "%"}), a.find(".progressbar .text").html(b + "%"), e = b)
                    };
                l(a, {
                    success: function (a, c) {
                        a.find(".progressbar .progress").css({width: "100%"}), c && c.filename && b ? window.location = b.replace("%HASH%", c.filename) : c && c.filename && d && (a.remove(), $("#" + d).find('input[type="submit"]').enable(!0), $("#" + d).find('input[name="file"]').val(c.filename + ".mp4"), $("#" + d).find('input[name="file_hash"]').val(c.filename))
                    }, beforeSerialize: function (a) {
                        var b = "";
                        if (a.find('[name="url"]').val() || a.find('[name="content"]').val() || a.find('[name="content[]"]').val() || a.find('[name="embed"]').val()) {
                            for (var c = 0; c < 32; c++) b += "" + Math.floor(10 * Math.random());
                            a.find('[name="filename"]').val(b)
                        } else a.find('[name="filename"]').val(b)
                    }, beforeSubmit: function (a) {
                        if (e = 0, a.append($('<div class="progressbar"><div class="progress"></div><div class="text"></div></div>')), "url" == a.find('[name="upload_option"]:checked').val() && c) {
                        ...
                        "url" != a.find('[name="upload_option"]:checked').val() && g(b)
                    }, complete: function (a) {
                        a.find(".progressbar").hide().remove(), f && clearTimeout(f)
                    }
                }), a.find('[name="upload_option"]').change(function () {
                    var b = $(this);
                    if (b.prop("checked")) {
                        var c = "disabled";
                        "file" == b.val() ? (a.find('[name="content"]').parents(".file-control").find("input").removeAttr(c).click(), a.find('[name="url"]').attr(c, c).val("").change(), a.find('[name="embed"]').attr(c, c).val("").change().parents(".row").find("label").removeClass("required"), a.find('[name="duration"]').attr(c, c).val("").change().parents(".row").find("label").removeClass("required"), a.find('[name="screenshot"]').parents(".file-control").find("input").attr(c, c).val("").change().parents(".row").find("label").removeClass("required")) : "url" == b.val() ? (a.find('[name="content"]').parents(".file-control").find("input").attr(c, c).val("").change(), a.find('[name="url"]').removeAttr(c).focus(), a.find('[name="embed"]').attr(c, c).val("").change().parents(".row").find("label").removeClass("required"), a.find('[name="duration"]').attr(c, c).val("").change().parents(".row").find("label").removeClass("required"), a.find('[name="screenshot"]').parents(".file-control").find("input").attr(c, c).val("").change().parents(".row").find("label").removeClass("required")) : "embed" == b.val() && (a.find('[name="url"]').attr(c, c).val("").change(), a.find('[name="content"]').parents(".file-control").find("input").attr(c, c).val("").change(), a.find('[name="embed"]').removeAttr(c).focus().parents(".row").find("label").addClass("required"), a.find('[name="duration"]').removeAttr(c).parents(".row").find("label").addClass("required"), a.find('[name="screenshot"]').parents(".file-control").find("input").removeAttr(c).parents(".row").find("label").addClass("required"))
                    }
                });
                var h = {mode: "async", format: "json", action: a.find('[name="action"]').val()};
                a.attr("action", (a.attr("action") || "") + ((a.attr("action") || "").indexOf("?") >= 0 ? "&" : "?") + $.param(h))
            })
        }, E = function () {
            $('[data-action="message"],[data-action="add_to_friends"]').click(function (a) {
                ...
                if (!b.hasClass("done")) {
                    ...
                    "add_to_friends" == b.attr("data-action") && (c = ".popup-add-to-friends"), $.fancybox($(c).clone(!0, !0), {
                        afterShow: function () {
                            var a = this.inner.find("form");
                            l(a, {
                                success: function () {
                                    b.addClass("done"), $.fancybox.close(), "add_to_friends" == b.attr("data-action") && window.location.reload()
                                }
                            }), g(this.inner)
                        }, helpers: {overlay: {closeClick: !1}}, topRatio: .3
                    })
            ...
            a.exists() && (g(a), l(a, {
                success: function (a, b) {
                    ...
                    var d = a.attr("data-block-id"), e = $(".list-messages");
                    if (b && d && e.exists()) {
                        j(d, null, {
                            success: function (a, f) {
                                var g = document.createElement("DIV");
                                if (g.innerHTML = f, c) e.find('.item[data-message-id="' + b.message_id + '"]').replaceWith($(g).find('.item[data-message-id="' + b.message_id + '"]')); else {
                                    var h = $(g).find('.item[data-message-id="' + b.message_id + '"]').addClass("hidden");
                                    e.find("#" + d + "_items").append(h), setTimeout(function () {
                                        e.show(), h.fadeIn()
                                    }, 200)
                                }
                            }
                ...
                a.preventDefault();
                var b = $(this), c = b.attr("data-confirm") || "";
                if (!c || confirm(c)) {
                    var d = b.attr("data-user-id");
                    if (!d) return;
                    var e = b.attr("data-block-id"), f = {};
                    f.function = "get_block", f.block_id = e, f.action = b.attr("data-action"), f.conversation_user_id = d, k(b, f, function (a) {
                        "success" == a.status && window.location.reload()
                    })
                }
            }), $(document).on("click", ".list-messages [data-edit-message-id]", function (a) {
                a.preventDefault();
                var b = $(this), c = b.attr("data-edit-message-id");
                if (c) {
            ...
            var a = function (a) {
                ...
                if (c.indexOf("#") > 0 && (c = c.substring(0, c.indexOf("#"))), c.indexOf("?") >= 0 ? c += "&" : c += "?", "js_stats" == a && b) {
                    if (b.disableStats) return;
                    b.videoId && (c += "video_id=" + b.videoId + "&"), b.albumId && (c += "album_id=" + b.albumId + "&")
                }
                (new Image).src = c + "mode=async&action=" + a + "&rand=" + (new Date).getTime()
            };
            if ($.cookie("kt_tcookie", "1", {
                expires: 7,
                path: "/"
            }), "1" == $.cookie("kt_tcookie") && a("js_stats"), b && b.userId) {
                var c = function () {
                    a("js_online_status")
                };
                c(), setInterval(c, 6e4)
            ...
            a.exists() && h(a.first())
        }, I = [o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F, G, H], J = 0; J < I.length; J++) if ("function" == typeof I[J]) try {
            I[J].call(this)
        } catch (a) {
